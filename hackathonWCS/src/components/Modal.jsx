    ...
    <div>
      ...
      <div className={modalOpen ? "block" : "hidden"}>
        <div
          ...
          aria-hidden="true"
          onClick={handleModal}
          className="flex bg-black bg-opacity-50 p-10 backdrop-blur-sm overflow-y-auto overflow-x-hidden fixed top-0 left-0 md:inset-0 z-50 w-full h-full justify-center pt-10"
        ></div>
        <div className="relative w-full max-w-2xl h-ffit md:h-auto">
          <div className="absolute z-50 bg-white rounded-lg shadow dark:bg-gray-700">
